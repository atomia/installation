class atomia_pa_haproxy(
	$atomia_pa_haproxy_user,
	$atomia_pa_haproxy_password
	) {
	...
	$haproxy_conf = generate("/etc/puppet/modules/atomia_pa_haproxy/files/atomia-pa-haproxy.conf.sh", $atomia_pa_haproxy_user,$atomia_pa_haproxy_password)
	...
	file { "/etc/default/haproxy":
		source => "puppet:///modules/atomia_pa_haproxy/haproxy-default",  
		require => Package["atomia-pa-haproxy"],
		notify => Exec["restart-haproxy"],
	}
